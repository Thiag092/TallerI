  ...
  <div class="card mt-4">
      ...
      <div class="container">
        <div class="row">
          <div class="col text-center">
            <h1 class="text-center h2 h1-md text-md-left mt-4 mt-5" style="text-decoration: underline">CONSULTA DE USUARIO</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="row text-center text-md-left mt-4" style="margin-left: 3px">
      ...
      <div class="col-s-12 col-md-12 col-lg-6 col-xl-8">
        <form class="row g-3 needs-validation" action="<?= base_url('enviar_consulta2') ?>" method="post" novalidate>
