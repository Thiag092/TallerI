...
<footer class="footer1">
      <div class="container text-center text-md-left mt-5">
        <div class="row text-center text-md-left">
          ...
          <div class="col-s-12 col-md-12 col-lg-4 col-xl-4">
            <h5 class="text-uppercase mb-4 font-weight-bold text-info mt-5" style="text-decoration: underline">Nosotros</h5>
            <hr clasee="mb-4">
            
            <h5 class="tituloNosotros" style="text-align: justify">Desde 2002 te acompañamos en el mundo musical, capacitándonos día a día para brindar los mejores productos, servicios 
              y nuestra gran experiencia.</h5>
          ...
          <div class="col-s-12 col-md-12 col-lg-4 col-xl-4">
            <h5 class="text-uppercase mb-4 font-weight-bold text-info mt-5" style="text-decoration: underline">Seguinos en nuestras redes</h5>
            <hr clasee="mb-4">
          ...
          <div class="col-s-12 col-md-12 col-lg-4 col-xl-4">
            <h5 class="text-uppercase mb-4 font-weight-bold text-info mt-5" style="text-decoration: underline">Contactanos</h5>
            <hr clasee="mb-4">
