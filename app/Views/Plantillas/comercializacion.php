...
<ul>
    <li>
        Con tarjetas VISA, MASTER y AMEX BANCARIAS, podés pagar hasta en 3 cuotas SIN INTERÉS.</li>
<li>
         Con tarjetas VISA, MASTER y AMEX BANCARIAS, podés pagar hasta en 6 cuotas SIN INTERÉS en compras mayores
             a $99.999.- (NO INCLUYE ARTÍCULOS EN PROMOCIÓN)</li>
    <li>
    NARANJA X con plan Z y 5 cuotas sin interés.</li>
    <li>
      Con tarjetas VISA y MASTER, NO BANCARIAS, pagás cuotas FIJAS con intereses (dependiendo del tipo de tarjeta y la cantidad de cuotas).
        Este tipo de tarjetas deben ser procesadas desde la opción "Mercado Pago" y no desde "Tarjetas de Crédito".</li>
</ul>
<hr class="linea">
...
<ul>
    <li>Podés abonar con tarjetas de crédito, débito, efectivo o Mercado Crédito. Las cuotas y promociones vigentes están establecidas por
     Mercado Pago. Todas estas transacciones corren bajo la plataforma Mercado Pago de la empresa Mercado Libre. Si tenés dudas al
      respecto podés consultar el sitio web de mercadopago.com.ar</li>
      </ul>
...
<ul>
    ...
    Pagá con tu APP de MODO o desde tu Homebanking, escaneá el QR y aboná con la forma de pago que prefieras. Podes acceder a
     descuentos exclusivos y beneficios que ofrece MODO.</li>
</ul>
<hr class="linea">
...
<li>Tipo de envío únicamente para CABA y GBA. Entrega hasta en 48hs hábiles. En caso de no poder realizar la entrega en la primera 
    visita, se realizará un segundo intento de entrega en las siguientes 24hs.</ul>
</ul>
<hr class="linea">
...
Si tu compra es inferior a $69.999, podes calcular el costo del envío y el tiempo estimado de entrega ingresando el código 
postal en la página del producto.</li>
</ul>
<hr class="linea">
